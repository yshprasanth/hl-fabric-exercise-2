...
cat << EOF > DevServer_connection.json
{
    ...
    "certificateAuthorities": {
        "ca.org1.dtlab.com": {
            "url": "http://${HOST}:7054",
            "caName": "ca.org1.dtlab.com"
        }
    }
}
EOF

PRIVATE_KEY="${DIR}"/composer/crypto-config/peerOrganizations/org1.dtlab.com/users/Admin@org1.dtlab.com/msp/keystore/381b12e983df1d5d4a7660f6cc0dc1ee331f2a89049f8e6713f9cc68c2deaaa9_sk
